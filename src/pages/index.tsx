  ...
  return (
    <>
      ...
      <main>
        ...
        {/*          Tọa lạc ngay ngã tư Văn Phú được khởi công xây dựng năm*/}
        {/*          2021 và hoàn thành vào 2023. Chung cư được xây dựng trên diện tích 450m2, gồm*/}
        {/*          30 tầng, tầng 1 làm kiot, 4 tầng đế, 24 tầng nhà ở và 1 tầng penhouse.*/}
        {/*        </p>*/}
        {/*      </div>*/}
            ...
            <div className="items-center flex flex-wrap">
              <div className="w-full md:w-4/12 ml-auto mr-auto px-4">
                <img
                  ...
                  src="https://vn.jwmarriotthanoi.com/resourcefiles/home-content-section-image/picnic-ben-ho.jpg?version=5272024095109"
                />
              </div>
              <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                <div className="md:pr-12">
                  ...
                  <h3 className="text-3xl font-semibold">BlueMoon là chung cư danh giá bậc nhất</h3>
                  <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                    Tọa lạc ngay ngã tư Văn Phú được khởi công xây dựng năm
                    2021 và hoàn thành vào 2023. Chung cư được xây dựng trên diện tích 450m2, gồm
                    30 tầng, tầng 1 làm kiot, 4 tầng đế, 24 tầng nhà ở và 1 tầng penhouse.
