              ...
              >
                <div className="relative flex flex-col min-w-0 break-words w-full shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    <Sun className="w-12 h-12 mb-4 mx-auto"/>
                    <h6 className="text-xl font-semibold">Tiện Nghi Cao Cấp</h6>
                    <p className="mt-2 font-light mb-4">
              ...
              >
                <div className="relative flex flex-col min-w-0 break-words w-full shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Vị Trí Chiến Lược</h6>
              ...
              >
                <div className="relative flex flex-col min-w-0 break-words w-full shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">An Ninh Tuyệt Đối</h6>
                    <p className="mt-2 mb-4 font-light">
            ...
            <div className="flex flex-wrap items-center mt-8">
              ...
              <motion.div
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg">
                  <img
                    alt="..."
                    src="https://file.canho.com.vn/the_wings_3_4e54a888ae.jpg"
            ...
            <div className="items-center flex flex-wrap">
              ...
              >
                <img
                  ...
                  src="https://homeid.asia/wp-content/uploads/2022/09/tienich3.jpg"
                />
              </motion.div>
              <motion.div
                initial={{opacity: 0, x: 50}}
